...
class TestWeatherOutputAdapter(TestCase):
    ...
    @patch("src.adapters.output.weather_output_adapter.get")
    def test_get_timeline(self, get_mock):
        ...
        location = "Reston,VA"
        result = self.adapter.get_timeline(location)
        self.assertEqual(result["address"], location)
